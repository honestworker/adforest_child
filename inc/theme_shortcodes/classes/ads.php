...
class ads
{
    	...
    	if ( $ads->have_posts() ) {
    		...
    		while ( $ads->have_posts() ) {
                ...
                if( function_exists("adforestCustomFieldsHTML") ) {
                    $more_detail_info = adforestCustomFieldsHTML(get_the_ID(), 4, 1);
                }
    			$my_ads .= '<div class="item"><div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" id="holder-'.get_the_ID().'">
    							...
    							<!-- Image Box -->
    								...
    								'.$outer_html.'
    							    <!-- Short Description -->
    							    <div class="short-description-1 mystyle">
        								<!-- Category Title -->
        								<div class="category-title"> '.$cats_html.' </div>
        								    <!-- Ad Title -->
        								    <h3>
    ...
    function adforest_search_layout_grid_1( $pid, $col = 6, $sm = 6, $holder = '' ) {
        ...
        $more_detail_info = "";
        if(function_exists('adforestCustomFieldsHTML')) {
            $more_detail_info = adforestCustomFieldsHTML(get_the_ID(), 6, 1);
        }
            				  ...
            				  <div class="white category-grid-box-1">
            					...
            					<div class="short-description-1">
            						...
            						<div class="category-title"> '.$cats_html.' </div>
            						    ...
            						    <div class="category-title row" style="margin-left: 0px;">
                                            <ul>'. $more_detail_info . '</ul>
                                        </div>
            						    <!-- Location -->
            						    <p class="location"><i class="fa fa-map-marker"></i> '.get_post_meta(get_the_ID(), '_adforest_ad_location', true ).'</p>
            						    <span class="ad-price">'.  adforest_adPrice(get_the_ID()).'</span>
    	...
    	return '<div class="col-md-'. esc_attr( $col ).' col-xs-12 col-sm-'. esc_attr( $sm ).'">
    			    ...
    			    <div class="category-grid-box">
        				...
        				<div class="short-description">
            				...
            				<div class="ad-info row" style="margin-left: 0px;">
            				    <ul>'. $more_detail_info . '</ul>
            				</div>
        					<!-- Price -->
        					<div class="price">
    ...
    function adforest_search_layout_grid_4( $pid, $col = 6 , $sm = 6, $holder = ''  ) {
        ...
        //<div class="listing-title row" style="margin-left: 0px;"><ul>'. $more_detail_info .'</ul></div>
    ...
    function adforest_search_layout_list( $pid, $col = 12 ) {
    	...
    	$output .= ' <div class="category-title">
                    ...
                    <div class="category-title row" style="margin-left: 0px;"><ul>'. $more_detail_info .'</ul></div>
    ...
    function adforest_search_layout_list_2( $pid, $is_show = true, $cols = '' ) {
        ...
        //<div class="row" style="margin-left: 0px; font-size: 12px"><ul>'. $more_detail_info .'</ul></div>
    	return '
                ...
                <!-- Content Block -->
                    <div class="'.esc_attr($list_col_2).'">
                        ...
                        <div class="ad-archive-desc">
                            ...
                            <!-- Ad Features -->
                            '. $options_html .'
                            <div class="category-title"><div class="clearfix visible-xs-block"></div></div>
                            <!-- Ad History -->
    ...
    function adforest_modern_search_layout1( $args ) {
    	$ads = new WP_Query( $args );
    	if ( $ads->have_posts() ) {
            $layout_html   = '';
            while( $ads->have_posts() )
            {
                $ads->the_post();
                $pid	=	get_the_ID();
                $layout_html .= $this->adforest_search_layout_list($pid, false);
            }
            $pagenation_html = adforest_pagination_modern_search1($ads);
        } else {
            $layout_html = '';
            $pagenation_html = get_template_part( 'template-parts/content', 'none' );
        }
        
        return '<!-- Middle Content Area -->
